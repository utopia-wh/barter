		...
		<div class="row clearfix" style="margin-top: 50px;">
			<div class="col-md-12 column">
				...
				<table class="table table-bordered">
					...
					<c:forEach items="${collecttList}" var="collect">
						<tbody>
							<tr class="active">
								<td>${collect.goodsName}</td>
								<td>${collect.goodsType}</td>
								<td>${collect.collectTime}</td>
								<td><a
									href="QueryOneGoodsByGoodsIdController?goodsId=${collect.goodsId}">查看</a>
								</td>
								<td><a
									href="DeleteOneCollectController?collectId=${collect.collectId}&useId=${sessionScope.user.userId}">删除</a>
								</td>
							</tr>
