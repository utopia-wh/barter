			...
			<div class="col-md-10 column" style="margin-left: 130px;">
				...
				<table class="table table-bordered">
					...
					<c:forEach items="${goodsList}" var="goods">
						<tbody>
							<tr class="active">
								<td>${goods.userEmail}</td>
								<td>${goods.goodsName}</td>
								<td>${goods.goodsType}</td>
								<td>${goods.goodsReleaseTime}</td>
								<td><a
									href="QueryOneGoodsByGoodsIdController?goodsId=${goods.goodsId}">查看</a>
								</td>
								<td><a
									href="UpdateGoodsStatusByGoodsIdController?goodsId=${goods.goodsId}">审核通过</a>
								</td>
								<td><a
									href="DeleteOneGoodsController?goodsId=${goods.goodsId}&goodsStatus=${goods.goodsStatus}">删除</a>
								</td>
							</tr>
