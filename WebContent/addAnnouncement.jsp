...
<link rel="stylesheet" href="bootstrap/css/bootstrap.min.css"
	type="text/css" />
<link rel="stylesheet" href="css/addAnnouncement.css" type="text/css" />
	...
	<div class="container">
		...
		<div style="margin-left: 300px;">
			<form class="form-horizontal"
				action="AddAnnouncementController?userEmail=${user.userEmail}"
				method="post">
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">公告内容</label>
					<div class="col-sm-10">
						<textarea class="form-control" rows="5" name="announcementContent"
