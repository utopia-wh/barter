...
<script type="text/javascript">
	...
	if (status == 2) {
		alert("请使用自己的物品和别人进行换物")
	}
	if (status == 3) {
		alert("请先登录")
	}
	if (status == 5) {
		alert("请检查你用于换物的物品编号是否正确")
	}
</script>
</head>
<body
	...
	<div class="container">
		...
		<div style="margin-left: 400px;">
			<form class="form-horizontal"
				action="AddOneExchangeController?exchangeSenderEmail=${sessionScope.user.userEmail}"
				method="post">
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">换此物</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="inputPassword3"
							readonly="true" placeholder="对方的物品编号"
							name="exchangeReceiverGoodsId"
							value="<%=request.getParameter("goodsId")%>">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">对方邮箱</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="inputPassword3"
							readonly="true" placeholder="对方邮箱" name="exchangeReceiverEmail"
							value="<%=request.getParameter("userEmail")%>">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">用此物换</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="inputPassword3"
							placeholder="请输入用于交换的物品编号" name="exchangeSenderGoodId">
					</div>
				</div>

				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">交换理由</label>
					<div class="col-sm-10">
						<textarea class="form-control" rows="5" style="width: 400px;"
							placeholder="添加交换理由" name="exchangeReason"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" class="btn btn-default">请求换物</button>
					</div>
				</div>
			</form>
		</div>
